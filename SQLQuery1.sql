...
(1, 'Bruschetta de Tomate y Albahaca', 'Tostadas de pan crujientes cubiertas con tomate fresco, albahaca y ajo.', 'Pan, Tomates, Albahaca, Ajo, Aceite de oliva, Sal, Pimienta', '4 rebanadas de pan, 2 tomates, 1/2 taza de albahaca, 1 diente de ajo, 2 cucharadas de aceite de oliva, al gusto', 'Tostar el pan. Cortar los tomates en cubos y mezclar con la albahaca, el ajo, el aceite de oliva, la sal y la pimienta. Colocar la mezcla sobre el pan tostado.', '15 minutos', 2, 1, 'Aperitivo', 'Italiana'),
(2, 'Guacamole', 'Dip cremoso hecho con aguacate, cebolla, cilantro, jugo de limón y especias.', 'Aguacate, Cebolla, Cilantro, Jugo de limón, Sal, Pimienta', '2 aguacates, 1/2 cebolla, 1/4 taza de cilantro, 2 cucharadas de jugo de limón, al gusto', 'Machacar el aguacate con un tenedor. Agregar la cebolla picada, el cilantro, el jugo de limón, la sal y la pimienta. Mezclar bien.', '10 minutos', 4, 1, 'Aperitivo', 'Mexicana'),
...
(2, 'Maria Rodriguez', 'maria.rodriguez@example.com', 'password456'),
(3, 'Pedro Garcia', 'pedro.garcia@example.com', 'password789'),
(4, 'Ana Gonzalez', 'ana.gonzalez@example.com', 'password012'),
(5, 'Luis Martinez', 'luis.martinez@example.com', 'password345'),
(6, 'Sofia Hernandez', 'sofia.hernandez@example.com', 'password678'),
(7, 'Carlos Lopez', 'carlos.lopez@example.com', 'password901'),
(8, 'Isabel Sanchez', 'isabel.sanchez@example.com', 'password234'),
(9, 'David Ramirez', 'david.ramirez@example.com', 'password567'),
(10, 'Laura Torres', 'laura.torres@example.com', 'password890');
